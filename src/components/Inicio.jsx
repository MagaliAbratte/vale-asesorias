...
import logoTikTok from './assets/tiktok-logo-icon.png'
       ...
       <Container>
        ...
        <Row>
         ...
         <div className='home-div'>
          ...
          <p className='home-texto'>Estilo Personal, Silueta, Colorimetria y mucho mas...</p>
       ...
       <Container>
        <Row>
         ...
         <div>
          ...
          <a href="https://www.instagram.com/vale.asesorias/" target='_blank'><img src={logoInstagram} alt="Logo Instagram" /></a>
         </div>
         </Col>
         <Col className='text-center'>
         <div>
          <p>¡Seguime en TikTok!</p>
          <a href="https://www.tiktok.com/@valeasesorias" target='_blank'><img src={logoTikTok} alt="Logo Tiktok" /> </a>
         </div>
         </Col>
        </Row>
       </Container>
